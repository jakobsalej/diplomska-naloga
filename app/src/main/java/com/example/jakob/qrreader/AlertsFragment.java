...
public class AlertsFragment extends Fragment {
    ...
    private RecyclerAdapterMonitoringAlerts mAdapterAlerts;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (type.equals("alertsMonitoring")) {
            mAdapterAlerts = new RecyclerAdapterMonitoringAlerts(MonitorService.alerts);
    ...
    public void updateFragmentData(String newData) {
        //items.
        if (mAdapter != null) {
            Log.v("ALERTS", "UPDATING!!");
