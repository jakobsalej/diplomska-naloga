...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // TODO: add markers from document and adjust camera view
        // Add a marker in Ljubljana and move the camera
        LatLng ljubljana = new LatLng(46.0569, 14.5058);
        LatLng start = new LatLng(46.1569, 14.7058);
        LatLng end = new LatLng(46.2569, 14.2058);
