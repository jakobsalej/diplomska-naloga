...
import static com.example.jakob.qrreader.Main2Activity.preferenceKey;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static String authUrl = "https://diploma-server-rest.herokuapp.com/api/users/auth";
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                out.writeBytes("email=" + mEmail + "&password=" + mPassword);
                conn.connect();

                int responseCode = conn.getResponseCode();
                if (responseCode == HttpsURLConnection.HTTP_OK) {
                    // if email and password is correct, get user
